 ...
 */
final class Version20220606194041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE odiseo_affiliate (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, product_id INT DEFAULT NULL, token_value VARCHAR(255) NOT NULL, expires_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_3256F409BEA95C75 (token_value), INDEX IDX_3256F4099395C3F3 (customer_id), INDEX IDX_3256F4094584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
