...
final class Version20220822142035 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE odiseo_affiliate_referral (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, product_id INT DEFAULT NULL, token_value VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, expires_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_83F20EA0BEA95C75 (token_value), INDEX IDX_83F20EA09395C3F3 (customer_id), INDEX IDX_83F20EA04584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE odiseo_affiliate_referral ADD CONSTRAINT FK_83F20EA09395C3F3 FOREIGN KEY (customer_id) REFERENCES sylius_customer (id) ON DELETE CASCADE');
